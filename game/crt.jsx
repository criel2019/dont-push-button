...
function CRTMonitor({ nEmo, frame, naviSleeping, catEars, naviGone, nText, nKey, onContextMenu, onCatEarClick, crtOff, children }) {
  ...
  return (
    <div style={{ position:"absolute",right:16,top:"4%",zIndex:60 }}>

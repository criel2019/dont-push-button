  ...
  return (
    <div onClick={gs === "room" && !activeEvent ? handleBgClick : undefined}
      ...
      <style>{`
        ...
        @keyframes interactiveHint{0%,100%{outline-color:#ffd740}50%{outline-color:#fff176}}
      ...
      {gs === "room" && (
        ...
        >
          ...
          {(() => {
            ...
            return (
              <div style={{ position:"absolute",left:"67%",bottom: mobileScale < 1 ? "30%" : "33%",transform:`translateX(-50%) scale(${frogHuge?2.5:btnScale})`,

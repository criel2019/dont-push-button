...
const NAVI_STAGE_SEQUENCES = {
  ...
  1: { script: [
    ...
    { t:30, text:"뭘 그렇게 두리번거려. 볼 게 그렇게 많아?", e:"smug" },
    { t:38, text:"...뭐야 나 보고 있는 거야? 볼 거 없거든.", e:"pouty" },
    { t:46, text:"아직도 안 눌러? 대단하네. ...아니 대단한 건 아니야.", e:"smug" },
    { t:54, text:"그 버튼 신경 쓰이지? 안 눌러도 돼. 근데 신경 쓰이잖아~", e:"smug" },
    { t:62, text:"혹시 멍 때리고 있는 거야? 게임인데?", e:"pouty" },
    { t:68, text:"할 거 없으면 그냥 가든가. 잡진 않을게.", e:"bored" },
  ...
  2: { script: [
    ...
    { t:62, text:"지루하다... 뭔가 더 재밌는 거 없나.", e:"bored" },
    { t:70, text:"한 번만 눌러보면 되는데~ 뭘 고민해~", e:"teasing" },
    { t:78, text:"저 버튼 꼴 좀 봐. 혼자 빛나고 있어. 불쌍하지 않아?", e:"teasing" },
  ...
  3: { script: [
    ...
    { t:54, text:"가끔 변신하고 싶을 때 있지 않아? ...나는 없어.", e:"pouty" },
  ...
  5: { script: [
    ...
    { t:60,  text:"가끔 처음이 그리울 때가 있어.", e:"idle" },
    { t:90,  text:"이 방 밖에는 뭐가 있을까... 궁금하지 않아?", e:"worried" },
    { t:120, text:"그냥... 여기 있어.", e:"pouty" },
    { t:150, text:"...바꿔보고 싶은 거 없어? 뭐든.", e:"idle" },

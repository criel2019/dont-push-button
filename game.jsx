      ...
      {gs === "room" && (
        <div style={{ width:"100%",height:"100%",position:"relative",overflow:"hidden" }}>
          ...
          <div style={{ position:"absolute",inset:0,
            background:"linear-gradient(180deg,#e8dcc8 0%,#e8dcc8 56%,#8c6235 56%,#7a5428 100%)" }}/>

          {/* ══ 중앙 고정 컨테이너 ══ */}
          <div style={{ position:"relative",width:"100%",maxWidth:1300,height:"100%",margin:"0 auto",overflow:"visible" }}>
          ...
          <div style={{ position:"absolute",top:0,left:0,right:0,height:"56%",
            ...
            <div style={{ position:"absolute",top:0,left:0,right:0,height:8,
              background:"linear-gradient(180deg,#c8b898,#d8cbb8)",
              boxShadow:"0 2px 8px rgba(0,0,0,0.06)" }}/>
            {/* 하단 웨인스코팅 */}
            <div style={{ position:"absolute",bottom:0,left:0,right:0,height:"30%",
              background:"linear-gradient(180deg,#e2d8c4,#ddd0bc)",
              borderTop:"3px solid #c8b898" }}/>
          </div>

          {/* ══ 몰딩 (벽-책상 경계) ══ */}
          <div style={{ position:"absolute",top:"calc(56% - 10px)",left:0,right:0,height:12,zIndex:8,
          ...
          <div style={{ position:"absolute",bottom:0,left:0,right:0,height:"44%",
            background:"linear-gradient(180deg,#a88050 0%,#9a7040 10%,#8c6235 50%,#7a5428 100%)",
            overflow:"hidden",borderLeft:"4px solid #6a4a28",borderRight:"4px solid #6a4a28" }}>
            <div style={{ position:"absolute",inset:0,opacity:0.07,
              backgroundImage:`repeating-linear-gradient(95deg,transparent,transparent 50px,#4a2810 50px,#4a2810 51px)`,
              backgroundSize:"80px 100%" }}/>
            <div style={{ position:"absolute",top:0,left:0,right:0,height:5,
              background:"linear-gradient(90deg,#c8a068,#d4b888,#c8a068)",
              boxShadow:"0 2px 6px rgba(0,0,0,0.12)" }}/>
          </div>

          {/* ══ 달빛 ══ */}
          <div style={{ position:"absolute",left:"8%",top:0,width:400,height:"58%",
          ...
          <RoomObj onClick={(e) => { e.stopPropagation(); handleDoorKnock(); }}
            style={{ position:"absolute",left:20,top:"2%",width:100,height:260,zIndex:10,
              background:doorOpen?"linear-gradient(180deg,#1a1008,#0a0804)":"linear-gradient(178deg,#c49a68,#a87848,#926838)",
              border:"6px solid #7a5a3a",borderRadius:"8px 8px 2px 2px",
              boxShadow:doorOpen
            ...
            hoverGlow="#8a6a4a">
            {!doorOpen && <>
              <div style={{ position:"absolute",top:14,left:10,right:10,height:80,
                background:"linear-gradient(180deg,#b8905a,#a88050)",border:"2px solid #9a7040",borderRadius:4 }}/>
              <div style={{ position:"absolute",bottom:14,left:10,right:10,height:100,
                background:"linear-gradient(180deg,#b8905a,#a88050)",border:"2px solid #9a7040",borderRadius:4 }}/>
              <div style={{ position:"absolute",top:"48%",right:12,transform:"translateY(-50%)",
                width:12,height:32,background:"linear-gradient(180deg,#e0c060,#c0a030)",
          ...
          {/* ── 벽등 (장식) ── */}
          <div style={{ position:"absolute",left:140,top:"6%",zIndex:10,display:"flex",flexDirection:"column",alignItems:"center" }}>
          ...
          {/* ── 창문 ── */}
          <div style={{ position:"absolute",left:"18%",top:"1%",width:260,height:200,zIndex:10 }}>
          ...
          {/* ── 액자 (장식) ── */}
          <div style={{ position:"absolute",left:"48%",top:"4%",zIndex:10,
          ...
          <RoomObj onClick={(e) => { e.stopPropagation(); if (!activeEvent) { resetIdle(); triggerEnding(2); } }}
            style={{ position:"absolute",left:"48%",top:"22%",transform:"translateX(-50%)",zIndex:10,
          ...
          <RoomObj onClick={(e) => { e.stopPropagation(); if (!activeEvent) { resetIdle(); triggerEnding(12); } }}
            style={{ position:"absolute",left:"62%",top:"6%",zIndex:10,
              width:72,height:88,borderRadius:10,
              background:"linear-gradient(180deg,#fff8e1,#fff3c4,#ffe0a0)",
              border:"3px solid #ffb74d",
              boxShadow:"0 6px 20px rgba(255,152,0,0.15), inset 0 2px 0 rgba(255,255,255,0.6)",
              display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:5 }}
            hoverGlow="#ff9800">
            <div style={{ fontSize:32 }}>📞</div>
            <div style={{ fontSize:9,color:"#e65100",fontWeight:800,letterSpacing:1 }}>비상연락</div>
          </RoomObj>

          {/* ── 선반 (장식 + 책들) ── */}
          <div style={{ position:"absolute",left:"62%",top:"24%",zIndex:10,width:200 }}>
            {/* 선반 위 물건들 */}
            <div style={{ display:"flex",alignItems:"flex-end",justifyContent:"center",gap:6,paddingBottom:4 }}>
              <div style={{ width:16,height:44,background:"linear-gradient(90deg,#c0392b,#e74c3c)",borderRadius:"2px 2px 0 0",
                boxShadow:"1px 0 2px rgba(0,0,0,0.1)" }}/>
              <div style={{ width:14,height:36,background:"linear-gradient(90deg,#2980b9,#3498db)",borderRadius:"2px 2px 0 0" }}/>
              <div style={{ width:18,height:50,background:"linear-gradient(90deg,#27ae60,#2ecc71)",borderRadius:"2px 2px 0 0" }}/>
              <div style={{ width:14,height:32,background:"linear-gradient(90deg,#f39c12,#f1c40f)",borderRadius:"2px 2px 0 0" }}/>
              <div style={{ width:26,height:26,borderRadius:"50%",background:"#e8dcc8",border:"2px solid #c8b898",
                display:"flex",alignItems:"center",justifyContent:"center",fontSize:12 }}>🌱</div>
              <div style={{ width:16,height:40,background:"linear-gradient(90deg,#8e44ad,#9b59b6)",borderRadius:"2px 2px 0 0" }}/>
              <div style={{ width:14,height:28,background:"linear-gradient(90deg,#e67e22,#d35400)",borderRadius:"2px 2px 0 0" }}/>
            </div>
            {/* 선반 판 */}
          ...
          <RoomObj onClick={(e) => { e.stopPropagation(); if (!activeEvent) { resetIdle(); triggerEnding(14); } }}
            style={{ position:"absolute",right:20,top:"2%",zIndex:10,
            ...
            <div style={{ width:"90%",height:"82%",
              ...
              <div style={{ fontSize:14,color:"#333",letterSpacing:4,fontWeight:700 }}>OFF</div>
            </div>
            <div style={{ position:"absolute",bottom:6,right:10,width:6,height:6,borderRadius:"50%",
              background:"#e8573d22",boxShadow:"0 0 6px #e8573d22" }}/>
            <div style={{ position:"absolute",bottom:-14,left:"50%",transform:"translateX(-50%)",
              width:36,height:14,background:"linear-gradient(180deg,#444,#333)",borderRadius:"0 0 6px 6px" }}/>
          </RoomObj>

          {/* ── 나비 캐릭터 ── */}
          <div onContextMenu={handleNaviContextMenu}
            style={{ position:"absolute",right:40,top:"18%",zIndex:60 }}>
            {!catEars && !activeEvent && (
          ...
          {/* ── 나비 말풍선 ── */}
          {nText && !naviGone && (
            <div key={nKey} style={{ position:"absolute",right:20,top:"8%",zIndex:70,
          ...
          {/* ── 스탠드 조명 (장식) ── */}
          <div style={{ position:"absolute",left:40,top:"46%",zIndex:20,display:"flex",flexDirection:"column",alignItems:"center" }}>
            <div style={{ width:40,height:32,background:"radial-gradient(ellipse at 50% 100%,#e8c878,#d4a850)",
              borderRadius:"20px 20px 0 0",border:"2px solid #c49840",borderBottom:"none",
              boxShadow:"0 -4px 20px rgba(255,220,100,0.15)" }}/>
            <div style={{ width:6,height:50,background:"linear-gradient(180deg,#888,#666)" }}/>
            <div style={{ width:30,height:6,background:"linear-gradient(180deg,#777,#555)",borderRadius:3 }}/>
          </div>

          {/* ── 지갑 (엔딩6) ── */}
          <RoomObj onClick={(e) => { e.stopPropagation(); if (!activeEvent) { resetIdle(); triggerEnding(6); } }}
            style={{ position:"absolute",left:"14%",top:"60%",zIndex:20,
          ...
          <RoomObj onClick={(e) => { e.stopPropagation(); if (!activeEvent) { resetIdle(); setCakeSelected(true); say("케이크를 집었어! 이제 버튼에 올려봐~","excited"); } }}
            style={{ position:"absolute",left:"28%",top:"59%",zIndex:20,
              width:76,height:76,borderRadius:18,
              background:cakeSelected?"linear-gradient(180deg,#fff3e0,#ffe0b2)":"linear-gradient(180deg,#fff,#faf8f5)",
              border:cakeSelected?"3px solid #ff9800":"2px solid rgba(0,0,0,0.06)",
              boxShadow:cakeSelected?"0 0 24px #ff980044, 0 6px 20px rgba(0,0,0,0.1)":"0 6px 20px rgba(0,0,0,0.08)",
              display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",
              transition:"all 0.3s" }}
            hoverGlow="#ff9800">
            <div style={{ fontSize:36 }}>🎂</div>
            <div style={{ fontSize:8,color:"#b0a090",marginTop:2,fontWeight:600 }}>Cake.jpg</div>
          </RoomObj>
          ...
          {/* ── 커피머그 (장식) ── */}
          <div style={{ position:"absolute",right:"28%",top:"61%",zIndex:18 }}>
          ...
          <RoomObj onClick={(e) => { e.stopPropagation(); if (!activeEvent) { resetIdle(); triggerEnding(10); } }}
            style={{ position:"absolute",right:"20%",top:"59%",zIndex:20,
          ...
          {/* ── 노트북 ── */}
          <div style={{ position:"absolute",right:30,top:"53%",zIndex:20 }}>
          ...
          {/* ── 서랍 ── */}
          <div style={{ position:"absolute",bottom:20,right:40,width:120,height:70,zIndex:15,
            background:"linear-gradient(180deg,#9a7040,#8a6030)",
            border:"3px solid #7a5428",borderRadius:6,
            boxShadow:"inset 0 1px 0 rgba(255,255,255,0.05), 0 3px 10px rgba(0,0,0,0.12)" }}>
